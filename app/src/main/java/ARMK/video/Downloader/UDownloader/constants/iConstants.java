package ARMK.video.Downloader.UDownloader.constants;
...
public interface iConstants {
    ...
    public static final String WEB_DISABLE = "We cannot allow to download videos form this website.";
     ...
     public static final String DOWNLOAD_DIRECTORY="UDownloader";
     public Integer[] HomePageThumbs = {R.drawable.img_logo_youtube,R.drawable.img_logo_facebook,R.drawable.img_logo_instagram,R.drawable.img_logo_twitter,R.drawable.img_logo_pinterest,R.drawable.dailymotion,R.drawable.img_logo_tumblr,R.drawable.img_logo_vimeo,R.drawable.img_logo_vine,R.drawable.img_logo_keek};
     public String[] HomePageURI = {"https://www.youtube.com","http://facebook.com","http://instagram.com","http://twitter.com","http://pinterest.com","http://dailymotion.com","http://tumblr.com","http://vimeo.com","https://vine.co","https://k.to"};
